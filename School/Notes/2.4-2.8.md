...
• If the anion is a polyatomic ion, simply write  
the name of the polyatomic ion
smaller number  -ite (even)
larger number -ate (odd)
# Binary Compounds  
...
![[Pasted image 20230913122836.png]]

### Binary Ionic Compounds containing metal that forms more than one kind of  
...
• Nomenclature for metals that form more than one type of cation  
	...
	• Common metals that don’t require Roman numerals  
		• Silver, Zinc, and Cadmium (Ag+, Zn2+,and Cd2+)

![[Pasted image 20230913123943.png]]
...
## Oxygen-Containing (polyatomic anions)
